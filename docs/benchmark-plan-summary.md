...
- 本汇总保留三个既定资源包各 15 人天：Astra；Memory + 文档解析；RAG + NLP2SQL。文档信息提取作为新增独立工作包，按详细计划增加 5～8 人天。
...
| 文档信息提取 | **5～8** | 300 Case Manifest、Schema 与 Golden Adapter、两个产品 Runner、统一 Scorer、Smoke/Pilot、正式运行、差异复核与报告 |
| **合计** | **50～53** | Astra 15；Memory + 文档解析 15；RAG + NLP2SQL 15；文档信息提取新增 5～8 |

### 3.3 排期建议

- 按一人等效投入串行完成：50～53 个工作日，约 10～11 个工作周。
- 四个资源包并行、每包一人等效投入：约 15 个工作日；文档信息提取自身约 5～8 个工作日，账号/条款审批、环境阻塞和实际运行等待时间另计。
